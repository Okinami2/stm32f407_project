...
void hw_board_init(char *clock_src, int32_t clock_src_freq, int32_t clock_target_freq)
{
    ...
    HAL_GPIO_WritePin(RFMODPWR_EN_GPIO_Port, RFMODPWR_EN_Pin, GPIO_PIN_SET);
    HAL_GPIO_WritePin(ETHPWR_EN_GPIO_Port, ETHPWR_EN_Pin, GPIO_PIN_SET);
    HAL_GPIO_WritePin(nETH_INT_GPIO_Port, nETH_INT_Pin, GPIO_PIN_RESET);
