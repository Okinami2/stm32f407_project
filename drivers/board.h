 ...
 * Change Logs:
 * Date           Author       Notes
 * 2025-12-08     RealThread   first version
 */
...
#define BSP_CLOCK_SOURCE_FREQ_MHZ         ((int32_t)24)
...
/* I2C Expander Pins */
#define BSP_VCC_5V_EN_PIN       GET_PIN(A, 4)
#define BSP_ANPWR_EN_PIN        GET_PIN(B, 7)
#define BSP_I2C_3_8_EN_PIN      GET_PIN(E, 2)
#define BSP_I2C_3_8_BIT1_PIN    GET_PIN(D, 1)
#define BSP_I2C_3_8_BIT2_PIN    GET_PIN(D, 4)
#define BSP_I2C_3_8_BIT3_PIN    GET_PIN(B, 3)

/* ADC Clock Control Pins */
#define BSP_VCC_P_15_PIN        GET_PIN(F, 11)
#define BSP_VCC_N_15_PIN        GET_PIN(A, 3)
#define BSP_ADCCLK_EN_PIN       GET_PIN(E, 0)
#define BSP_ADCCLK_BIT0_PIN     GET_PIN(E, 4)
#define BSP_ADCCLK_BIT1_PIN     GET_PIN(E, 5)

/* ADC Interface Pins */
#define BSP_ADC_POWER_EN_PIN    GET_PIN(C, 6)
#define BSP_nADC_SYNC_PIN       GET_PIN(E, 6)
#define BSP_nADC_CS_PORT GPIOB
#define BSP_nADC_CS_PIN         GET_PIN(B, 6)
#define BSP_nADC_DRDY_PIN       GET_PIN(E, 1)
#define BSP_ADC_CLK_PIN         GET_PIN(B, 10) // SPI CLK
#define BSP_ADC_DOUT_PIN        GET_PIN(C, 2)  // SPI MISO
#define BSP_ADC_DIN_PIN         GET_PIN(C, 3)  // SPI MOSI

/* Oscillator Pins */
#define BSP_OSC32_IN_PIN        GET_PIN(C, 14)
#define BSP_OSC32_OUT_PIN       GET_PIN(C, 15)
#define BSP_OSC_IN_PIN          GET_PIN(H, 0)
#define BSP_OSC_OUT_PIN         GET_PIN(H, 1)

/* LED Indicator Pins */
#define BSP_LED_R_PIN           GET_PIN(F, 7)
#define BSP_LED_G_PIN           GET_PIN(F, 6)
#define BSP_LED_B_PIN           GET_PIN(A, 6)

/* Channel Alert Pins */
#define BSP_nCH0_ALERT_PIN      GET_PIN(E, 7)
#define BSP_nCH1_ALERT_PIN      GET_PIN(E, 9)
#define BSP_nCH2_ALERT_PIN      GET_PIN(E, 11)
#define BSP_nCH3_ALERT_PIN      GET_PIN(E, 13)
#define BSP_nCH4_ALERT_PIN      GET_PIN(E, 15)
#define BSP_nCH5_ALERT_PIN      GET_PIN(G, 0)
#define BSP_nCH6_ALERT_PIN      GET_PIN(B, 2)
#define BSP_nCH7_ALERT_PIN      GET_PIN(G, 1)

/* sd nand pins*/
#define BSP_TFPWR_EN_PIN        GET_PIN(E, 8)
#define BSP_GNSS_SW_PIN         GET_PIN(G, 3)
#define BSP_SD_CS_PIN           GET_PIN(D, 2)
#define BSP_RFMODPWR_EN_PIN     GET_PIN(G, 10)
#define BSP_GNSSPWR_EN_PIN      GET_PIN(G, 4)

#define PHY_RESET_PIN           GET_PIN(E, 14)
