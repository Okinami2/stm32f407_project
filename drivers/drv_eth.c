...
static void phy_linkchange()
{
    ...
    if (status & (PHY_AUTONEGO_COMPLETE_MASK | PHY_LINKED_STATUS_MASK))
    {
        ...
        {
            phy_speed_new |= LEG_PHY_FULL_DUPLEX;
        }
    }
    ...
    if (phy_speed != phy_speed_new)
    {
        ...
        if (phy_speed & PHY_LINK)
        {
            ...
            if (phy_speed & LEG_PHY_FULL_DUPLEX)
            {
                LOG_D("full-duplex");
...
{
    .init    = rt_stm32_eth_init,
    .open    = rt_stm32_eth_open,
    .close   = rt_stm32_eth_close,
    .read    = rt_stm32_eth_read,
    .write   = rt_stm32_eth_write,
    .control = rt_stm32_eth_control
};
#endif
